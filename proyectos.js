...
const projects = [
    ...
    {   
        name : "Blog Tutoria Net", 
        description : "Este es un blog de programacion, enfocado en mostrar a personas que no saben o estan entrando en este mundo de la programacion a ver un poco de trata y que temas puedan abordar dependiendo del puesto que quieran en un futuro, cuenta con pagina principal, pagina de contacto, pagina de blog en general donde puedes filtrar los blogs segun categoria y vista ampliada de cada blog, entre otros.", 
        imgSrc : "img-tutoria-net.avif", 
        enlaceWeb : "", 
        enlaceGit : "", 
        // tecnologias 
        js : "javascript",
    ...
    {   
        name : "React Router Dom Desde 0", 
        description : "Este es una herramienta que funciona como el react router dom soportando rutas y enrutado sencillo, cuenta como componentes como Links, Route, Router, etc. hecha con el fin de practicar logica en react y es facilmente montable como paquete de npm y se podria usar 100% como herramienta. ", 
        imgSrc : "img-router-dom.avif", 
        enlaceWeb : "", 
        enlaceGit : "https://github.com/Wmolina17/React-Router-Desde-0", 
        // tecnologias 
        js : "javascript",
        python : "",
        react : "react",
    ...
    {   
        ...
        enlaceWeb : "", 
        enlaceGit : "https://github.com/Wmolina17/React-Tic-Tac-Toe", 
        // tecnologias 
        js : "javascript",
        python : "node",
        react : "react",
